...
deffSettings={
	...
	moneyGreenCol=tocolor(0,150,0,255);
	moneyRedCol=tocolor(230,0,0,255);
	clipCol=tocolor(0,50,120,255);
	ammoCol=tocolor(200,200,200,255);
	...
	hudX=60;
	hudY=20; --x and y in pixels from right top corner to right top edge of weapon/money/time/wanted level hud area
	doDrawRadio=true;
	doDrawRadar=true;
	doDrawInfo=true;
	doDrawHUD=true;
	blipDimension=13*(sy/500)/2; --default size blip width,height
	x=0.110*sy*1.7;
